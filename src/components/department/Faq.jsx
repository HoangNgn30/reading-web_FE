...
function FAQ() {
    const faqData = [
        {
            question: 'Làm thế nào để trở thành sinh viên ngành CNTT trường Đại học Đại Nam?',
            answer: [
                'Năm 2024, ngành CNTT trường Đại học Đại Nam (mã trường DDN) tuyển sinh 1.000 chỉ tiêu hệ đại học chính quy ở các ngành CNTT (800 chỉ tiêu), ngành học máy tính (100 chỉ tiêu), Hệ thống thông tin (100 chỉ tiêu) theo 03 phương thức xét tuyển.',
        ...
        {
            question: 'Sứ mệnh của ngành Công nghệ thông tin',
            answer: [
                'Đào tạo để người học ra trường có cuộc sống tốt và là công dân tốt, là lực lượng lao động ngành học – công nghệ đi đầu  trong xã hội.',
            ],
        },
        {
            question: 'Mục tiêu phát triển của ngành Công nghệ thông tin',
            answer: [
                'Đến năm 2030, ngành Công nghệ thông tin trường Đại học Đại Nam là cơ sở đào tạo tin cậy hàng đầu Việt Nam về Công nghệ thông tin, ngành học máy tính, Hệ thống thông tin mà nổi bật là năng lực "Khởi nghiệp và đổi mới sáng tạo về công nghệ".',
            ],
        },
        {
            question: 'Giá trị bằng cấp',
            answer: [
                '1. Ngành Khoa học máy tính                       - Kỹ sư KHMT             - ĐH Đại Nam cấp.',
        ...
        },
        {
            ...
            answer: [
                '1. Ngành Khoa học máy tính                       - Học 4 năm    - Học 03 kỳ/năm.',
        ...
        },
        {
            ...
            answer: [
                'Công nghệ thông tin (CNTT) là một trong những ngành đào tạo mũi nhọn của trường Đại học Đại Nam, có số lượng sinh viên theo học rất lớn. Ngành học này thu hút sinh viên bởi cơ hội việc làm lớn, mức thu nhập cao, chương trình đào tạo đổi mới, phương pháp giảng dạy linh hoạt.',
