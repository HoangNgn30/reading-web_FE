        ...
        <div className="w-full">
            <div className="relative flex flex-col items-center justify-center w-full min-h-screen">
                <div className="absolute inset-0">
                    <img
                        src="https://itis-portfolio.vercel.app/backfix.png"
                        height="1500"
                        alt=""
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center px-10 lg:px-20 xl:px-32 2xl:px-40 mt-20 w-full  relative">
                    <div className="flex flex-col items-center gap-3 lg:items-start text-justify h-full w-full justify-center">
                        ...
                        >
                            Con tàu thám hiểm ITIS lừng danh cưỡi sóng vượt biển khám phá vùng đất mới, với hành trình
                            không ngừng nghỉ và chỉ trở về bến cảng mỗi năm một lần vào mùa thu. Ngoài bổ sung lương
                            thực và nhiên liệu thì còn có một nhiệm vụ vô cùng quan trọng, đó chính là tuyển thêm những
                            thuỷ thủ đoàn mới đầy tiềm năng!
                        </p>
                        <div
                    ...
                    <div className="w-full flex flex-col items-center justify-center py-4">
                        <img
                            src="https://itis-portfolio.vercel.app/thuyen0.png"
                            alt=""
